...
- Samme handlinger for alle, i denne rekkefølgen:
  ...
  (faktiske frames: idle=25, walk=25, hver frame 256x256. Se LES-MEG-grafikkformat.md)

Det fulgte INGEN JSON-atlas med — den trengs ikke. Grafikken kommer som
nummererte 256x256 PNG-frames (01.png, 02.png ...) i én mappe per animasjon,
pluss et valgfritt samlet _spritesheet.png. Les LES-MEG-grafikkformat.md for
alle detaljer om rutenett, plassering og hvordan nye karakterer legges til.
