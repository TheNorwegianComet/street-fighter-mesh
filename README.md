...
Et 2D fighting-spill i klassisk Street Fighter II-stil, bygget med HTML5 Canvas og vanilla JavaScript. Alle sprites er AI-generert med [AutoSprite](https://autosprite.io), stemmer med [ElevenLabs](https://elevenlabs.io).
